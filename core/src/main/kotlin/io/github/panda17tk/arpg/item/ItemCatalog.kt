...
object ItemCatalog {
    val ALL: List<ItemDef> = listOf(
        ...
        ItemDef("thruster_beast", "推進器「獣王の尾」", ItemKind.THRUSTER, desc = "獣王の腱で編んだ駆動索　立ち上がりも巡航も一段上", accelMul = 1.15f, cruiseMul = 1.1f),
        // --- 防具 (armor) ---
        ...
        ItemDef("melee_fang", "獣王の大牙", ItemKind.MELEE_WEAPON, desc = "頂点捕食者の牙そのもの　近接 +50% リーチ +15%", meleeDmgMul = 1.5f, meleeReachMul = 1.15f),
        ...
        ItemDef("acc_compass", "星渡りの羅針盤", ItemKind.ACCESSORY, desc = "帰る星を指し続ける　移動 +6% 回復 +5%", moveMul = 1.06f, staRegenMul = 1.05f),
        ItemDef("acc_idol", "氷の民の小さな偶像", ItemKind.ACCESSORY, desc = "祈りのぶんだけ固くなる　被ダメ -5% 回復 +5%", damageMul = 0.95f, staRegenMul = 1.05f),
        ItemDef("acc_ember", "燠火の欠片", ItemKind.ACCESSORY, desc = "溶岩の民の炉から　銃 +8% 近接 +5%", gunMul = 1.08f, meleeDmgMul = 1.05f),
