...
object MobFactory {
    ...
    fun spawn(world: World, def: EnemyDef, x: Float, y: Float, waveNum: Int = 1, hpScalePerWave: Float = 0f, speedScalePerWave: Float = 0f, tribe: Int = 0, dashes: Boolean = false): Entity {
