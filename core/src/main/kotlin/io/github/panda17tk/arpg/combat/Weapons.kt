...
object Weapons {
    val ALL: List<WeaponDef> = listOf(
        WeaponDef("pistol", "ピストル", 24f, 0.22f, 12, 0.05f, 1, "ammo9", reloadTime = 3.0f),
        ...
        WeaponDef("beam", "ビーム", 80f, 0.60f, null, 0f, 1, "ammoBeam", reloadTime = 0f),
        WeaponDef("grenade", "グレネード", 0f, 0.90f, 1, 0f, 1, "ammoNade", reloadTime = 1.5f),
    )
}
