...
class PlanetGravityTest {
    @Test fun `pulls toward a planet within range`() {
        val ps = listOf(PlanetBody(0f, 0f, 50f, 100f, 400f, Biome.ROCK))
    ...
    @Test fun `no pull beyond gravity range`() {
        val ps = listOf(PlanetBody(0f, 0f, 50f, 100f, 200f, Biome.ROCK))
    ...
    @Test fun `heavier planet pulls harder at the same distance`() {
        val light = PlanetGravity.gravityAccelAt(listOf(PlanetBody(0f, 0f, 50f, 100f, 400f, Biome.ROCK)), 100f, 0f).first
        val heavy = PlanetGravity.gravityAccelAt(listOf(PlanetBody(0f, 0f, 50f, 300f, 400f, Biome.ROCK)), 100f, 0f).first
